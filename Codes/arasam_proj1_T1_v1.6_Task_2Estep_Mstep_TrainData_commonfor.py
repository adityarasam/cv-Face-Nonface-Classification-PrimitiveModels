...
def E_step(x, Mean,Covar,Lmbda, rik): 
    global local_vars
    NoOfImages_train = 1000
    size = 5
    mean = Mean
    covar = Covar
    lmbda = Lmbda
...
def M_step(x, rik, NoOfImages_train):
...
if Task == 2:
    ...
    while (Convergence == False):
        ...
        r = E_step(x,mean,covar,lmbda, r)
    
        lmbda_t1, mean_t1, covar_t1 = M_step(x, r,NoOfImages_train)
