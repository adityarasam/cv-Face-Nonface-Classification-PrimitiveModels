...
while (Convergence == False):
        ...
        if converg_cntr > 5:#abs(lmbda_t0[0,0] - lmbda_t1[0,1]) < tolerance_mean:
            Convergence = True
...
x   =     np.zeros((1,Pixels), dtype=np.uint8)#[[0:10800]]
for i in range (1000,NoOfTestImages+1000):
    ...
    new_x_w1 = cv2.imread(image_path_test, RGB) 
